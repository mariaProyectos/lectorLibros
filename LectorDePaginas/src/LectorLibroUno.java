			...
			public void actionPerformed(ActionEvent e) {
				...
				if (archivo.exists())
					try {
						...
						// Leyendo byte a byte
						do{
							caracter = (char) bufer.read();
							txtrLaMejorHistoria.append(caracter + "");

						}while(txtrLaMejorHistoria.getHeight() > txtrLaMejorHistoria.getPreferredSize().getHeight());
